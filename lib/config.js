...
const config = {
  ...
  openai: {
    ...
    defaultTemp: 1.2,
    availableTones: [],
    userPromptPrefex: `Follow the instructions very strictly:
    ...
    \n- Keep the tone of the review to be professional and formal.
    \n- Do NOT use the same adjectives & ensure the final review sounds different from the following 3 reviews delimited in <Review> tag:`,
  },
