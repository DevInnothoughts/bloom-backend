...
const config = {
  ...
  openai: {
    ...
    \n- Write the 30 words review in either a first person perspective or a narrative style.
    ...
    \n- Keep the review short, clear, and to the point, without elaborating excessively on any single aspect.
    \n- Conclude the review **strictly** within 30 words. Any response exceeding this limit will be considered incorrect.`,
  },
